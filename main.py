...
app = FastAPI(
    ...
    description='An aPI that demonstrates checking the inference of the census classification',
    version='1.0.0'
)
...
async def create_item_for_model_inference(data:Data):
    ...
    X_test, _, _,_ = process_data(new_df,categorical_features=cat_features,training=False,encoder=encoder)
